...
import { LinkIcon, SparklesIcon, PencilIcon, CheckCircleIcon, MapPinIcon, PhoneIcon, GlobeAltIcon, HashtagIcon, ImageIcon } from '../ui/icons/Icons';
...
const SeoStrategy: React.FC<{ draft: ArticleDraft | HistoriaDraft }> = ({ draft }) => (
    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
        ...
        <div>
            ...
            <p className="text-sm text-gray-800 font-medium">{draft.focus_keyword}</p>
        </div>
        <div>
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Texto Alternativo Sugerido (Imagem)</h3>
            <p className="text-sm text-gray-800">{draft.suggested_alt_text}</p>
        </div>
    </div>
);
