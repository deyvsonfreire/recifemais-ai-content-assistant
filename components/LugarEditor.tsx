...
import { CameraIcon, ImageIcon, PlusIcon, TrashIcon, MagicWandIcon } from './icons/Icons';
...
const LugarEditor: React.FC<LugarEditorProps> = ({ lugarId, wordPressCredentials, onSave, onCancel }) => {
