...
import { WordPressCredentials, WordPressPost, SeoAnalysis, InitialPostData } from '../types';
...
const PostEditor: React.FC<PostEditorProps> = ({ postId, initialData, wordPressCredentials, onSave, onCancel }) => {
