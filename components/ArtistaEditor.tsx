...
import { CameraIcon, ImageIcon, PlusIcon, TrashIcon } from './icons/Icons';
...
const ArtistaEditor: React.FC<ArtistaEditorProps> = ({ artistaId, wordPressCredentials, onSave, onCancel }) => {
